...
class EnvConfig(NamedTuple):
    ...
    reachability_downsample_factor: int = 1
    macro_move_cost_per_tile: float = 0.1
    macro_move_dumpzone_closer_reward: float = 0.01
    macro_move_dumpzone_closer_reward_cap: float = 0.2
    macro_cabin_workspace_dig_reward: float = 0.05
    macro_move_reachability_inflation_tiles: int = 2
