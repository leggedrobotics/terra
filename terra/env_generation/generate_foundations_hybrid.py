...
def create_foundations_hybrid_standalone(
                                    ...
                                    min_dirt_tiles=40,  # Minimum dirt tiles like relocations_harder
                                    max_dirt_tiles=50): # Maximum dirt tiles like relocations_harder
    """
...
def generate_foundations_hybrid_standalone(config_path="config/env_generation_config.yaml",
    ...
    create_foundations_hybrid_standalone(
        ...
        min_dirt_tiles=40,  # Same as relocations_harder
        max_dirt_tiles=50,  # Same as relocations_harder
    )
