...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, required=True, choices=["gpt-4o", "gemini-1.5-flash-latest", "gemini-2.0-flash", "gemini-2.5-pro-exp-03-25"], help="Name of the LLM model to use.")
